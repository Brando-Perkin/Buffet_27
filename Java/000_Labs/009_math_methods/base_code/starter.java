...
class starter {
	public static void main(String args[]) {
		...
		System.out.println("Pick 2 numbers to do math with!");
		double x = sc.nextDouble();
		double y = sc.nextDouble();
		System.out.println("The max of your numbers is: ");
		System.out.println(Math.max(x,y));
		System.out.println("The square root of your second number is: ");
